...
type Props = { language:Language; campaignId:string; campaignRole:Role|null; mode?:'player'|'manager'; canManage?:boolean }
...
export default function MapsSection({ language, campaignId, campaignRole, mode='player', canManage=false }:Props) {
  const t = text[language]
  const isGm = campaignRole === 'gm' || campaignRole === 'co_gm'
  const canEdit = mode === 'manager' && (isGm || canManage)
